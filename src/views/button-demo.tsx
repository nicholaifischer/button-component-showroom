  ...
  return (
    <div className="flex items-center justify-between gap-4">
      ...
      <div className="flex items-center gap-1 w-[120px] shrink-0">
        ...
        />
        <Select value={value.u} onValueChange={(u: any) => onChange({ ...value, u })}>
        ...
        <AccordionItem value="animation" className="border-border/40">
          ...
          <AccordionContent className="pt-4 pb-2 px-1 space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Slider value={[hoverScale]} max={1.1} min={1.0} step={0.01} onValueChange={(v) => setHoverScale((v as number[])[0])} />
            </div>
            <div className="space-y-2">
              ...
              <Slider value={[activeScale]} max={1.0} min={0.9} step={0.01} onValueChange={(v) => setActiveScale((v as number[])[0])} />
            </div>
        ...
        <AccordionItem value="access" className="border-border/40 border-b-0">
          ...
          <AccordionContent className="pt-4 pb-2 px-1 space-y-4">
            ...
            <div className="space-y-2 pt-2">
              ...
              <Slider value={[disabledOpacity]} max={1.0} min={0} step={0.1} onValueChange={(v) => setDisabledOpacity((v as number[])[0])} />
            </div>
          </AccordionContent>
        </AccordionItem>
      </Accordion>
